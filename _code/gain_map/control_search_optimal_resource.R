...
global_start$start_params <- max_accuracy_rcw_uniform$optim_results$member$pop
global_start$start_params[,5] <- 0
global_start$start_params <- NULL
global_start$optimize_map <- optimize_map
...
rstudioapi::jobRunScript('~/Dropbox/Calen/Work/search/modeling/_analysis/_code/gain_map/_scripts/maximum_accuracy_uniform_rcw.R', 'max_accuracy_rcw_uniform', 
                         exportEnv = "max_accuracy_rcw_uniform", 
